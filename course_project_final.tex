...
\begin{itemize}
    ...
    \item Calculating the first-order differences of the log-transformed close prices to achieve stationarity, a requirement for ARIMA modeling, confirmed through the Augmented Dickey-Fuller (ADF) test.
    \item Creating an additional ordinal date feature by converting dates into numerical format, facilitating the use of date information in machine learning models that require numerical input.
\end{itemize}
