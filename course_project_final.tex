...
\begin{enumerate}
    ...
    \includegraphics[scale=0.25]{arimadonenow.png} %final-screenshots/SARIMA_results.jpg
    ...
    \includegraphics[scale=0.25]{arimadonenow.png} %final-screenshots/auto_arima_results.jpg
    ...
    \includegraphics[scale=0.25]{arimadonenow.png} %final-screenshots/ensemble_results
