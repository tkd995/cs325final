...
\includegraphics[scale=0.25]{linreg.png} % screenshots/linreg.png

\item{Random Forest: }
A Random Forest model does...  Benefits:  provided the best results Negatives:
\includegraphics[scale=0.25]{example-image.jpg} %screenshots/ranfor.png
...
\bibitem{b1}I. Parmar et al., “Stock Market Prediction Using Machine Learning,” 2018 First International Conference on Secure Cyber Computing and Communication (ICSCCC), Dec. 2018, doi: https://doi.org/10.1109/icsccc.2018.8703332.
‌
\end{thebibliography}
\vspace{12pt}
